...
## 研究領域 (Research Focus)
- **副作用発現メカニズムの探求:** 
  Kolmogorov-Arnold Networks (KAN) の解釈性を活用したToxicophore（毒性発現部位）の同定に取り組んでいます。高次元入力時の計算コスト増大や過学習への脆弱性といった**KAN固有の技術的限界**を客観的に評価し、アーキテクチャの最適化を通じたトレードオフの克服と、分子・受容体レベルでの安全性評価基盤の構築を目指しています。
- **実臨床データ（RWD）解析への展開:** 
