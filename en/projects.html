...
<ul>
    ...
    <li><b>Technical Approach:</b>
        <ul>
            <li><b>Multimodal Strategy:</b> Integrated pre-calculated quantum chemistry results (e.g., MACE-xTB) and 1,800+ descriptors. Specifically, developed a specialized feature space for fluorescence prediction by introducing unique Conjugation Features.</li>
